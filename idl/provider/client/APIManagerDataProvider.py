#
# DataProvider for APIManagerTemplate.
#
...
class APIManagerDataProvider(IDLDataProvider.IDLDataProvider):
    """
    APIManagerDataProvider provides DataObject containing client-side 
    APIManager info.
    """
